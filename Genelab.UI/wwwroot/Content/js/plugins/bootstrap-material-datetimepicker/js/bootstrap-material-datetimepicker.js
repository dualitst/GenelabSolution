(function ($, moment)
{
   ...
   function Plugin(element, options)
   {
      ...
      this.params = {date: true, time: false, format: 'DD / MMMM / YYYY', minDate: null, maxDate: null, currentDate: null, lang: 'es', weekStart: 0, shortTime: false, clearButton: true, nowButton: true, cancelText: 'Cancelar', okText: 'OK', clearText: 'Borrar', nowText: 'Hoy', switchOnClick: true};
