...
var Codigos = function () {
    ...
    var colDefs = [
        utils.fnAgGrid_ColumnBuilder({ header: "Código", field: "cve_codigo" }),
        utils.fnAgGrid_ColumnBuilder({ header: "Descripción", field: "desc_codigo" }),
        utils.fnAgGrid_ColumnBuilder({ header: "Catálogo", field: "cve_catalogo", sort:"asc" }),
        utils.fnAgGrid_ColumnBuilder({ header: "Resolución", field: "resolucion" }),
        utils.fnAgGrid_ColumnBuilder({ header: "Activo", field: "status" }),
    ...
    //----------------------
    function llenaGrid() {
        utils.fnAgGrid_SetRowsAPI(grdOptions, "Codigos/GetList", {}, false, "Originacion")
            .done(function (res) {
                grdOptions = res;
            })
            .done(function () {
