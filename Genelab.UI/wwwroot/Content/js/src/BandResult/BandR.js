...
var Usuarios = function () {
    ...
    var colDefs = [
        ...
        utils.fnAgGrid_ColumnBuilder({ header: "Rol", field: "paciente" }),
        utils.fnAgGrid_ColumnBuilder({ header: "Fceha", field: "fecha" }),
    ...
    //----------------------
    function llenaGrid() {
        utils.fnAgGrid_SetRowsAPI(grdOptions, "BandResult/list", {}, false, "Originacion")
            .done(function (res) {
                grdOptions = res;
            })
            .done(function () {
